...
<head>
<meta charset="utf-8">
<title>Cinema - Forget Password</title>
...
<div class="row">
    <div class="col-xs-12 col-sm-8 col-md-6 col-sm-offset-2 col-md-offset-3">
		<form role="form" name="form" id="form" class="register-form" method='post'>
				...
				if(empty($_POST['username']) || empty($_POST['email'])){
					...
					<div>
					    <div class="alert alert-danger fade in">
					        ...
					        <strong>Please input your username and email.</strong>
					    </div>
					</div>  					
					<?php
				}
			        ...
			        if($count == 1){
			            ...
			            <div class="alert alert-danger fade in">
			                <a href="#" class="close" data-dismiss="alert">&times;</a>
			                <strong>Invaild Username or email address</strong>
			            </div>
			            <?php    			        	
			        }
				}
			...
			<hr class="colorgraph">
			<div class="row">
				<div class="col-xs-12 col-md-6"><input type="submit" name="submit" id="submit" value="Forget Password" class="btn btn-danger btn-block btn-lg" tabindex="7"></div>
				<div class="col-xs-12 col-md-6">Remember your account? <a href="login.php">Sign in</a></div>
			</div>
		</form>
	</div>
</div>
