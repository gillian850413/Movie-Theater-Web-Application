...
$query_in="select movie_id, name, price from movie where CAST(open_date AS DateTime) <= curdate() order by open_date";	
		...
		<div class="row">	
			...
			<div class="col-lg-9">
				<div class="col-lg-12">
					<div class="row">
						<div class="col-lg-4">
							<label><font size=5>Upcoming</font></label>
						</div>	
						<div class="col-lg-8">
							<form method="post" >							
								<div class="col-lg-6 col-md-offset-3">
									...
									<?php
										if (isset($_POST['select'])){
										    ...
										    <option <?php if ($_POST['select'] == 'type') { ?>selected="true" <?php }; ?> value="type">Type</option>
				...
				<form>	
 					<?php
 						if(isset($_POST['sc'])){
							...
							$query_up="select m.movie_id, name, price from movie m, type t where CAST(open_date AS DateTime) > curdate() 
								AND m.movie_id=t.movie_id Group by (m.movie_id) order by ".$_POST['select']." ". $sort;			
 						}
 						else{
							$query_up="select movie_id, name, price from movie where CAST(open_date AS DateTime) > curdate() order by name"; 
 						} 		
	                        ...
	                        <div class="col-item">
								...
								<div class="info">
		                            <div class="caption">
		                            	...
		                            	<label class="pull-right"><font size=3><br><?php if($row[2]==0){echo "---";} else{echo "$".$row[2];}?></font></label>
		                            </div>	
		                                <div class="separator">	        
