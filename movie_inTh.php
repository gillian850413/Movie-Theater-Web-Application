		...
		<div class="row">	
			...
			<div class="col-lg-9">
				<div class="col-lg-12">
					<div class="row">
						<div class="col-lg-4">
							<label><font size=5>In Theater</font></label>
						</div>	
						<div class="col-lg-8">
							<form method="post" >							
				...
				<form>		
 					<?php		
 						if(isset($_POST['sc'])){
							...
							$query_in="select m.movie_id, name, price from movie m, type t where CAST(open_date AS DateTime) <= curdate() 
