...
<head>
	<meta charset="utf-8">
	<title>Cinema - <?php echo $lan?> Movie List</title>
		...
		<div class="row">
			<div class="col-lg-12">
				<ul class="breadcrumb">
					...
					<li class="active"><?php echo $lan?> Movies</li>
				</ul>
			</div>
		</div>
	</div>
		...
		<div class="row">	
			...
			<div class="col-lg-9">
				<div class="col-lg-12">
					<div class="row">
						<div class="col-lg-4">
							<label><font size=5><?php echo $lan?> Movies</font></label>
						</div>	
						<div class="col-lg-8">
							<form method="post" >							
 					...
 					<?php	
	 					if(isset($_POST['sc'])){ 	
	 						$sort = $_POST['sc'];										
								...
								$queryT="select m.movie_id, name, price, open_date from movie m, type t where language="."'".$lan."'"." 
								AND m.movie_id=t.movie_id Group by (m.movie_id) order by ".$_POST['select']." ". $sort;		 													
 						}
 						else{
							$queryT="select m.movie_id, name, price, open_date from  movie m, type t  where language="."'".$lan."'"." 
								AND m.movie_id=t.movie_id Group by (m.movie_id) order by name ";							 							
 						}							
