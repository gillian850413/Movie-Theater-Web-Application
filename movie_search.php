...
<head>
<meta charset="utf-8">
<title>Cinema - Movie Search</title>
...
$query_in="select movie_id, name, price from movie 
where CAST(open_date AS DateTime) <= curdate() order by name";	
$result_in = mysql_query($query_in, $conn);
$count_in=mysql_num_rows($result_in);

$query_up="select movie_id, name, price from movie 
where CAST(open_date AS DateTime) > curdate() order by open_date";
...
<div id="wrapper">
		...
		<div class="row">
			<div class="col-lg-12">
				<ul class="breadcrumb">
					...
					<li class="active">Movie Search</li>
				</ul>
			</div>
		</div>
	</div>
	...
	<div class="container">
		<div class="row">	
			...
			<div class="col-lg-9">
				<div class="col-lg-12">
					<h3>Search Result: <?php echo $search;?></h3>
				</div>
				<?php
				$query_search="select movie_id, name, price, open_date from movie where name LIKE '%". $search. "%' order by name";
				$result_search = mysql_query($query_search, $conn);
				...
				<form>	
 					<?php	
	 					for($i=0; $i<$count_search; $i++){
	 						$row = mysql_fetch_row($result_search); 
	 						?>
		 					<div class="col-lg-4">
		                        <div class="col-item">
		                            <div class="photo">
