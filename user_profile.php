...
<head>
<meta charset="utf-8">
<title>Cinema - View User Porfile</title>
		...
		<div class="row">
			...
			<div class="col-lg-3">
				...
				<div class="widget">
					...
					<ul class="cat"><b>
			            ...
			            <li>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<i class="fa fa-angle-right"></i><a href="ticket_purchase.php">Ticket Purchase</a></li></b>
					</ul>
				</div>
				</aside>
			</div> 
			...
			<div style="background-color: #CCC">
			    <div class="col-lg-6 col-md-offset-1">
					<form role="form" name="form" id="form" class="register-form" action="edit_profile_form.php" method='post'>
						...
						<div class="form-group">
						    <div class="input-group">
							    ...
							    <input type="text" class="form-control input-lg exampleclass" name="firstname" id="firstname" value="<?php echo $row[3]?>" readonly>
						...
						<div class="form-group">
						    <div class="input-group">
							    <div class="input-group-addon"><span class="glyphicon glyphicon-user" aria-hidden="true"></span></div>
							    <input type="text" class="form-control input-lg exampleclass" name="lastname" id="lastname" value="<?php echo $row[4]?>" readonly>
						...
						<div class="form-group">
						    <div class="input-group">
							    ...
							    <input type="text" class="form-control input-lg exampleclass" name="bday" id="bday" value="<?php echo $row[5]?>" readonly>
						...
						<div class="form-group">
						    <div class="input-group">
							    ...
							    <input type="text" class="form-control input-lg exampleclass" name="email" id="email" value="<?php echo $row[6]?>" readonly>
						...
						<div class="form-group">
						    <div class="input-group">
							    ...
							    <input type="text" class="form-control input-lg exampleclass" name="phone" id="phone" value="<?php echo $row[7]?>" readonly>
						...
						<hr class="colorgraph">
						<div class="row">
							<div class="col-xs-12 col-md-3"><input type="submit" name="update" id="update" value="Update" class="btn btn-theme btn-block btn-lg" tabindex="7"></div>
						</div>
					</form>
				</div>
			</div>
